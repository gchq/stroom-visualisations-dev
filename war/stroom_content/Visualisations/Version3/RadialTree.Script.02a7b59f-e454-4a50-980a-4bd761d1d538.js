...
visualisations.RadialTree = function() {
  ...
  function collapse(d,i) {
   if (d.children && d.children.length >= i) {
  ...
  var update = function(duration) {
    ...
    if (data) {
     ...
     // collapse(data,10);
      ...
      // nodes.forEach(function (d) {if (d.children) { if (depthCount[d.depth]) { depthCount[d.depth] = depthCount[d.depth] + d.children.length;} else {depthCount[d.depth] = d.children.length;}}});
   ...
   //     console.log(d.id+" old:"+d.y+" depth:"+d.depth);
     ...
     //   console.log("new:"+d.y);
      ...
      nodeEnter.append("svg:circle")
               ...
               .attr("r",function(d) {return Math.max(5,50/(d.depth?d.depth:1));});
